      ...
      <div className="relative container max-w-7xl mx-auto overflow-x-clip">
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-md my-10 max-w-xl text-center opacity-50">
            Explore our portfolio of innovative stage designs crafted for
            unforgettable events. Each photo highlights our expertise in
            creating immersive environments that captivate audiences and elevate
            brand experiences.
          </p>
